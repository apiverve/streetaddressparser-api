...
namespace APIVerve.API.StreetAddressParser
{
    ...
    /// <summary>
    /// Client for the StreetAddressParser API
    /// </summary>
    public class StreetAddressParserAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/streetaddressparser";
        ...
        {
            { "address", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public StreetAddressParserAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public StreetAddressParserAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public StreetAddressParserAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, StreetAddressParserQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(StreetAddressParserQueryOptions options)
        {
        ...
        public ResponseObj Execute(StreetAddressParserQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(StreetAddressParserQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(StreetAddressParserQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(StreetAddressParserQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(StreetAddressParserQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(StreetAddressParserQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(StreetAddressParserQueryOptions options)
        {
