...
//
//     StreetAddressParserData data = Converter.fromJsonString(jsonString);

package com.apiverve.streetaddressparser.data;
...
public class Converter {
    ...
    public static StreetAddressParserData fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    public static String toJsonString(StreetAddressParserData obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.readerFor(StreetAddressParserData.class);
        writer = mapper.writerFor(StreetAddressParserData.class);
    }
...
// StreetAddressParserData.java

package com.apiverve.streetaddressparser.data;

import com.fasterxml.jackson.annotation.*;

public class StreetAddressParserData {
