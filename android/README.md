# Street Address Parser Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:streetaddressparser-api:1.1.13'
}
```
...
```java
import com.apiverve.streetaddressparser.StreetAddressParserAPIClient;
import com.apiverve.streetaddressparser.APIResponse;
import com.apiverve.streetaddressparser.APIException;

// Initialize the client
StreetAddressParserAPIClient client = new StreetAddressParserAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("address", "1600 Amphitheatre Parkway, Mountain View, CA 90210");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/streetaddressparser](https://docs.apiverve.com/ref/streetaddressparser)
...
- **Documentation:** [https://docs.apiverve.com/ref/streetaddressparser](https://docs.apiverve.com/ref/streetaddressparser)
- **Issues:** [GitHub Issues](https://github.com/apiverve/streetaddressparser-api/issues)
