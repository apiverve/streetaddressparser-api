// Package streetaddressparser provides a Go client for the Street Address Parser API.
//
// For more information, visit: https://streetaddressparser.apiverve.com?utm_source=go&utm_medium=readme
package streetaddressparser
...
const (
	baseURL        = "https://api.apiverve.com/v1/streetaddressparser"
	defaultTimeout = 30 * time.Second
)

// Client is the Street Address Parser API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Street Address Parser API client.
...
// Execute makes a request to the Street Address Parser API with typed parameters.
//
...
//   - address (required): string - The street address to parse
