...
{
    class StreetAddressParserExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/streetaddressparser";

        /// <summary>
        /// Make a GET request to the Street Address Parser API
        /// </summary>
        static async Task<JsonDocument> CallStreetAddressParserAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;address&quot;] &#x3D; &quot;1600 Amphitheatre Parkway, Mountain View, CA 90210&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Street Address Parser API...\n");

            var result = await CallStreetAddressParserAPI();
